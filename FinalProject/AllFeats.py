...
print "All Six features are extracted and are considered as features"
improved = foo(url,all_feats)
print
...
print "Improved Classification of Test Sample"
customTest(s, improved, all_feats)
